...
| 5 | **Presentation registry** — *next* | Delete the `SkillDelivery` switches; cue ids in data. Unblocks art without touching rules. Statuses want overlays, so they arrive wanting this. | M |
